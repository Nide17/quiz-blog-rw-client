        ...
        <section className="about-section py-0 py-lg-4">
            ...
            <div className="container about-container">
                ...
                <Jumbotron className="p-2 text-center border border-info">
                    <h1 className="display-5 font-weight-bold text-success">Quiz-Blog</h1>
                ...
                <div className="row mx-4 my-5">
                    ...
                    <div className="col-12 col-sm-8">
                        <h2 className="py-3 font-weight-bolder w-100 text-info">Niyomwungeri Parmenide Ishimwe</h2>
