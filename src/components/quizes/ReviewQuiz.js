                                                ...
                                                auth.isAuthenticated ?
                                                    ...
                                                    <div className='score-section text-center'>
                                                        ...
                                                        <Button color="success" className="mt-3 share-btn mx-1 mx-md-3">
                                                            ...
                                                            <a className="text-white" href={`https://api.whatsapp.com/send?phone=whatsappphonenumber&text=Attempt this ${sC.oneScore.quiz.title} on Quiz Blog
                        \nhttp://www.quizblog.rw/view-quiz/${sC.oneScore.quiz._id}`}>Share</a>
                                                        </Button>
                                                        ...
                                                        <Col>
                                                            <div className="d-flex justify-content-around">
                                                                ...
                                                                {auth.user.role === 'Admin' ?
                                                                    <PDFDownloadLink
                                                                        document={<PdfDocument review={sC.oneScore.review} />}
                                                                        fileName={`${sC.oneScore.review.title.split(' ').join('-')}.pdf`}
                                                                        style={{
                                                                            textDecoration: "none",
                                                                            padding: "3px 5px",
                                                                            color: "white",
