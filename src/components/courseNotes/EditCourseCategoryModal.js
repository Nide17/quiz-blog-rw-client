...
const EditCourseCategoryModal = ({ idToUpdate, editTitle, editDesc, auth, updateCourseCategory }) => {
...
EditCourseCategoryModal.propTypes = {
    auth: PropTypes.object
}

export default connect(null, { updateCourseCategory })(EditCourseCategoryModal);
