...
const EditProfile = ({ auth, getSchools, schools, fetchSchoolLevels, schoolLevels, fetchLevelFaculties, levelFaculties, updateProfile, errors, successful, clearErrors, clearSuccess }) => {
...
export default connect(mapStateToProps, { getSchools, fetchSchoolLevels, fetchLevelFaculties, updateProfile, clearErrors, clearSuccess })(EditProfile);