            ...
            <div>
                ...
                <Modal
                    ...
                    <ModalBody>
                        ...
                        {this.state.msg ? (
                            <Alert color='danger' className='border border-warning'>{this.state.msg}</Alert>) : null}
                        ...
                        <div className="d-flex">
                            <p className="p-2">Having account?</p><LoginModal isAuthenticated={this.props.isAuthenticated} />
                        </div>
                    </ModalBody>
                </Modal>
            </div>
